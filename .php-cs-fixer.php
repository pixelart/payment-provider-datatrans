...
/*
 * This file is part of the Pixelart Pimcore Ecommerce Bundle.
 *
...
$finder = PhpCsFixer\Finder::create()
    ...
    ->notContains('class Configuration implements ConfigurationInterface') // Ignored the symfony Configuration definition because it cleans it wrong
    ->in(__DIR__)
    ->append([
